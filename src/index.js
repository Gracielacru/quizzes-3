...
const isSunny = true;
const activity = isSunny === true ? "Go to the beach" : "Stay indoors";
...
const outfit = temperature <= 22 ? "Wear a jacket" : "T-shirt is fine";
...
const isApple = fruitsList[0] === "apple" ? true : false;
...
const isLengthFive = "hello".Lenght === 5 ? true : false;
